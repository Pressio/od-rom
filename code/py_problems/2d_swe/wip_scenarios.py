...
base_dic[-1] = {
  'fom' : {
    'meshSize': [128, 128],
    'finalTimeTrain': 4.0, 'finalTimeTest' : 1.0,
  ...
  'rom' : {
    'finalTime': 1.0,
    'inviscidFluxReconstruction' : "Weno5",
    'odeScheme': "RK4", 'dt' : 0.008
  },
  'physicalCoefficients': {'gravity': 9.8, 'coriolis':"p0", 'pulsemag':"p1"}
}

train_points[-1] = {0: [-3.0, 0.125]}
test_points[-1]  = {0: [-2.0, 0.5]}
