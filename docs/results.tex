...
\item Error vs. time-step size? Need to explicitly state that FOM time-step size is the maximum value for stability. 
...
\begin{itemize}
\item CPU and/or wall time comparisons for a given accuracy level. We should explicitly state the ROM dimension. 
